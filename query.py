...
def ask_llm(context, question, model):
    ...
    If the answer exists in the context, give only the answer.

    If the answer does not exist, reply:

    "The information is not available in the provided document. Kindly contact college office for further assistance"
